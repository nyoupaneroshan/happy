      ...
      <div className="container">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">(+977) 970-9011011</span>
              </li>
              <li className="flex items-center">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="#" className="text-gray-400 hover:text-primary-500 text-sm">Terms of Service</a>
            <a href="#" className="text-gray-400 hover:text-primary-500 text-sm">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
